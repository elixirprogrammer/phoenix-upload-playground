defmodule UploadPlaygroundWeb.AvatarControllerTest do
  use UploadPlaygroundWeb.ConnCase

  alias UploadPlayground.Users

  @create_attrs %{avatar: "some avatar", image: "some image"}
  @update_attrs %{avatar: "some updated avatar", image: "some updated image"}
  @invalid_attrs %{avatar: nil, image: nil}

  def fixture(:avatar) do
    {:ok, avatar} = Users.create_avatar(@create_attrs)
    avatar
  end
